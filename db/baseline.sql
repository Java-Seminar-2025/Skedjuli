...
CREATE TABLE course_req (
                            ...
                            CONSTRAINT uq_course_req UNIQUE (course_id, req_course_id)
);
...
CREATE TABLE enrollment_form_items (
                                       ...
                                       CONSTRAINT uq_form_item UNIQUE (enrollment_form_id, course_id)
);
...
CREATE TABLE completed_courses (
                                   ...
                                   CONSTRAINT uq_completed UNIQUE (student_id, course_id)
);
